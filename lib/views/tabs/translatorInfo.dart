...
class TranslatorInfo extends StatefulWidget {
  @override
  _TranslatorInfoState createState() => _TranslatorInfoState();
}

class _TranslatorInfoState extends State<TranslatorInfo> {
  @override
          ...
          child: Column(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  Image.asset("assets/images/profile.png", height: 220,width: 100,),
                  SizedBox(
                    width: 20,
                  ),
                  Container(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            IconButton(icon: Icon(Icons.call),highlightColor: Color(0xffFFECDD), onPressed: null),
